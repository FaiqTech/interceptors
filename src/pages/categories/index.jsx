...
import CustomSpinner from "../../components/spinner/index.jsx";
...
const Categories = () => {
    ...
    return (
        isFetching ? <CustomSpinner/> : <Container fluid className="mt-5">
            <Modal isOpen={modal} toggle={toggleModal}>
                ...
                <ModalBody>
                    <form id="add-category" onSubmit={handleSubmit(addCategory)}>
                        ...
                        <div>
                            ...
                            <Controller render={({field: {value, onChange}}) => (
                                <select className="form-control" name="type" id="type" value={value}
                                        onChange={onChange}>
                                    {types.map(item => (
                ...
                <ModalFooter>
                    <Button color="primary" type="button" outline>Close</Button>
                    ...
                    <Table hover responsive bordered>
                        ...
                        {data.map((item, index) => (
                            <tr key={item.id}>
                                ...
                                <td>
                                    <Button color="danger" onClick={() => deleteCategory(item.id)}><FaTrash
